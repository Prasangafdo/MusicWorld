...
<body>
  <header>
      ...
      <p style="font-size:26px"> <marquee behavior="scroll" direction="right" scrollamount="7">Albums</marquee></p>
      <p style="font-size:18px"> <marquee behavior="scroll" direction="left" scrollamount="5">Euphoria</marquee></p>
  	  <p style="font-size:16px"> <marquee behavior="scroll" direction="right" scrollamount="8">Insomniac</marquee></p>
      <p style="font-size:18px"> <marquee behavior="scroll" direction="left" scrollamount="4">1989</marquee></p>
      <p style="font-size:16px"> <marquee behavior="scroll" direction="right" scrollamount="3">Unapologetic</marquee></p>
      <p style="font-size:20px"> <marquee behavior="scroll" direction="left" scrollamount="5.5">Anti</marquee></p>
...
$query = "SELECT Album_Name, Artist, Year, Description FROM
albums";
...
<p><a href="mailto:support@company.com">support@musicworld.com</a></p>
			...
			<div class="footer-right">
				...
				<p class="footer-company-about">
					...
					We created this website as an assignment of Data, Schemas &amp; Applications of The University of the West of England 
