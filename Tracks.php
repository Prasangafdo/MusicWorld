...
<body>
  <header>
      ...
      <p style="font-size:22px"> <marquee behavior="scroll" direction="right" scrollamount="8">Here are some of popular tracks</marquee></p>
      <p style="font-size:24px"> <marquee behavior="scroll" direction="left" scrollamount="4">Select the artist for more tracks</marquee></p>
