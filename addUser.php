...
$pasword=$_POST['pass1'];
$statement="INSERT INTO users(email, first_name, last_name, dob, country, password)
  VALUES ('$email','$fname','$lname','$dob','$country',md5($pasword))";
    ...
    <div id="intro">
      <section class="clear">
        ...
        <article class="two_quarter">
		  ...
		  if ($result)
		  {?>
		  <p>Dear <?php echo $fname; ?>, your account has been created successfully
		  <?php
		  }
		  else
		  {
