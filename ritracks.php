...
<body>
  <header>
      ...
      <p style="font-size:22px"> <marquee behavior="scroll" direction="right" scrollamount="8">Rihanna</marquee></p>
      <p style="font-size:24px"> <marquee behavior="scroll" direction="left" scrollamount="4">Popular tracks of Rihanna</marquee></p>
