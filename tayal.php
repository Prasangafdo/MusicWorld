...
<body>
  <header>
      ...
      <p style="font-size:20px"> <marquee behavior="scroll" direction="right" scrollamount="3">Albums of Taylor</marquee></p>
...
albums WHERE Artist=('Taylor Swift')";
