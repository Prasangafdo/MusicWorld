...
<body>
      ...
      <p style="font-size:24px"> <marquee behavior="scroll" direction="right" scrollamount="3">Listen to millions of songs online for free</marquee></p>
      <p style="font-size:20px"> <marquee behavior="scroll" direction="left" scrollamount="2">It's easy</marquee></p>
...
<body>
<?php
mysqli_connect("localhost", "root", "", "musicworld") or
